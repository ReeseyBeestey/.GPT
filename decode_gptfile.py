...
# Example usage:
input_gpt_path = r"C:\Users\mcari\Documents\optimized_image.gpt"  # Path to the .gpt file
output_png_path = r"C:\Users\mcari\Desktop\reconstructed_image(3).png"  # Path for the decoded image (with .png extension)
